...
class ROIRelationHead(Module):
    ...
    def forward(self, features, proposals, targets=None, logger=None):
        ...
        #     p.add_field("img_path", t.get_field("img_path"))
        ...
        if self.weak_sup and self.training:
            ...
            loss_relation, loss_refine = self.wsup_loss_evaluator(proposals, rel_labels, relation_logits, refine_logits, attn_score)
        else:
