...
def do_vg_evaluation(
    ...
    zeroshot_triplet = torch.load("data/datasets/evaluation/vg/zeroshot_triplet.pytorch"+str(cfg.MODEL.ROI_RELATION_HEAD.NUM_CLASSES-1), map_location=torch.device("cpu")).long().numpy()
